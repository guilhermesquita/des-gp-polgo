...
const create_winner_validation_factory_1 = require("./create-winner-validation.factory");
const makeCreateWinnerController = () => {
    return new create_winner_controller_1.CreateWinnerController((0, create_winner_usecase_factory_1.createWinnerFactory)(), (0, create_winner_validation_factory_1.makeAddDreamValidation)());
};
