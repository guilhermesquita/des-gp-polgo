...
import { IWinner } from "../../../../../../features/winners/domain/model/winner.model";

describe("GetWinnersPageable Usecase", () => {
  let getWinnersPageable: GetWinnersPageable;

  const mockData: IWinner[] = [
    {
      nome: "Maria",
      estado: "SP",
      cidade: "São Paulo",
  ...
  beforeEach(() => {
    getWinnersPageable = {
      pageable: jest.fn(
        async ({ pageable, filters }: GetWinnersPageable.Params) => {
